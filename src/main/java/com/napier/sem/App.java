...
public class App {
    ...
    /**
     * Gets all the current employees and salaries of a role.
     * @return A list of all employees and salaries of the role, or null if there is an error.
     */
        ...
        try
        {
            ...
            String strSelect =
                    "SELECT employees.emp_no, employees.first_name, employees.last_name, titles.title, salaries.salary, departments.dept_name, dept_manager.emp_no "
                            ...
                            + "WHERE employees.emp_no = salaries.emp_no AND employees.emp_no = titles.emp_no AND employees.emp_no = " + ID;
            // Execute SQL statement
            ResultSet rset = stmt.executeQuery(strSelect);
